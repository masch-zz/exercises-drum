...
public class ExerciseDTO extends ItemExerciseDTO {
	...
	public boolean equals(Object obj) {
		...
		return ((super.equals(exerciseCompareDTO))
				&& (this.levelExerciseDTO.equals(exerciseCompareDTO
						.getLevelExerciseDTO())) && (this.chapterExerciseDTO
					.equals(exerciseCompareDTO.getChapterExerciseDTO())));
	}
	...
	public int hashCode() {
		return new HashCodeBuilder(INITIAL_ODD_NUMBER_HAS_CODE,
				...
				append(levelExerciseDTO).append(chapterExerciseDTO)
				.toHashCode();
	}
